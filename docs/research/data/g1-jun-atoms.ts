...
const FIREFLY_WINDOW_BODY = `**观萤时间窗**：

1. **夏至到 7 月中旬**（约 2026/06/21 – 07/15）为高峰期。2026 夏至 = 6/21（撞端午最后一天）。窗口右侧偏后 — 7 月初到中旬密度反而比夏至当周更高。
2. **最佳天气**：闷热无月光的夜晚（农历月中前后 = 月亮最亮，反而看不到，避开）。
3. **最佳时段**：日落后 30 分钟到 22:00 之间。`;
...
export const G1_JUN_CURATED_VIEWS: PathCuratedViewSeedRow[] = [
  {
    ...
    heart: "六月节气密、家长容易想\"全都做\"。挑 1 件做透比 4 件都做一半强。她记住的是\"6 月看了一次萤火虫\"，不是\"做了 6 件事\"。",
    output: "本子上 \"6 月观察清单\"——至少 1 个雨季动物 + 1 个夜观记录。两条就够。",
    serendipity: "家门口反而是观察\"自然有节奏\"的最好实验室，因为变化是孩子能在 1 周内自己看见的。",
    proseBlocks: [
      {
        key: "leadLine",
        label: "一句话",
      ...
      },
      {
        key: "heart",
        label: "心法",
        value: "六月节气密、家长容易想\"全都做\"。挑 1 件做透比 4 件都做一半强。她记住的是\"6 月看了一次萤火虫\"，不是\"做了 6 件事\"。",
      },
    ],
  ...
  },
  {
    ...
    whySpecial: "入梅当天 + 之后 1 周是黄金窗口——第一场连续大雨之后小生物集体出现。错过这 1 周，很多就回到土里了。这张卡反过来——告诉家长她家 50 米内就有 100 种生物。低门槛、高频次，是月度 baseline 的支撑面。",
    heart: "“雨后第二天 7 点”是一个观察习惯 (routine)。一旦养成，她以后听到下雨就会期待第二天能看到什么。这是观察习惯，不是知识点。",
    output: "本子上记 \"雨后清单\"——一次能记到 2–4 种。3 次累积下来，她对家门口物种数量会有自己的估计。",
    serendipity: "每年梅雨季观察同一面墙，会让孩子感悟自然的生命轮回。",
    proseBlocks: [
      {
        key: "leadLine",
        label: "触发条件",
      ...
      },
      {
        key: "whySpecial",
        label: "为什么特别",
        value: "入梅当天 + 之后 1 周是黄金窗口——第一场连续大雨之后小生物集体出现。错过这 1 周，很多就回到土里了。这张卡反过来——告诉家长她家 50 米内就有 100 种生物。低门槛、高频次，是月度 baseline 的支撑面。",
      },
      {
        key: "output",
        label: "产出",
        value: "本子上记 \"雨后清单\"——一次能记到 2–4 种。3 次累积下来，她对家门口物种数量会有自己的估计。",
      },
      {
        key: "heart",
        label: "心法",
  ...
  },
  {
    ...
    whySpecial: "上海近郊萤火虫高峰在夏至到 7 月中旬。再早成虫期未到，再晚密度骤降。每年只开这一扇窗，错过等下一年。",
    ...
    serendipity: "在静默的黑夜中与微光相遇，是童年不可多得的唯美时刻。",
    proseBlocks: [
      {
        key: "leadLine",
        label: "触发条件",
      ...
      },
      {
        key: "whySpecial",
        label: "为什么特别",
        value: "上海近郊萤火虫高峰在夏至到 7 月中旬。再早成虫期未到，再晚密度骤降。每年只开这一扇窗，错过等下一年。",
      },
      {
        key: "output",
        label: "产出",
