...
const SECTIONS_C1: ActivitySection[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        html: '上海公办小学一般 6/30 前后开始放暑假。六月最后一周不用赶活动，<b>留出留白</b>给孩子收尾本学期作业 + 期末。我们 7 月卡再接上暑期主线。',
      },
      {
        type: 'callout',
        variant: 'heart',
    ...
    blocks: [
      {
        ...
        opts: [
          ...
          },
          {
            ...
            effortKey: 'no',
            bodyHtml:
              '<p>不出门也行。买<b>新鲜艾草 + 菖蒲 + 雄黄</b>（菜场或社区团购），让孩子摸 / 闻 / 认。包 5 个粽子（速冻粽叶超市有），和孩子一起绑线。比远途奔波留下的具体感受更多。</p>',
          },
        ],
      },
    ],
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '<b>雄黄</b>——不是植物，是<b>含砷矿物粉</b>。<u>不要让孩子接触口腔</u>，闻一下就行。古方点额头是仪式感不是药用。',
        ],
      },
    ],
  },
