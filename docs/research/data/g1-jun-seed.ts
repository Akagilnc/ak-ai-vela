        ...
        opts: [
          {
            ...
            effortKey: 'low',
            bodyHtml:
              '<p><b>闵行浦江郊野公园</b>——端午前后有官方"召楼粽情"端午文化节（非遗市集 + 民俗游戏 + 包粽子体验，文旅部官方推广），4A 景区，地铁 8 号线沿园区延伸。<b>嘉定毛桥集市</b>是配套选项（生态市集 + 小吃）。一日往返，下午 3 点前回家避高峰。</p>',
          },
          {
            letter: 'B',
            label: '江浙短途 2 晚',
            ...
            effortKey: 'med',
            bodyHtml:
              '<p><b>绍兴上虞 / 台州 / 宁波</b>——浙江粽子 + 杨梅核心产区。<b>浙江杨梅 6 月初就开始上市</b>，端午（6/19）正在杨梅季中后期（已熟透到落市前）；可去民宿提前约采摘。两晚短住，避开高速 6/19 早 + 6/21 晚两次峰值。</p>',
          },
          {
            letter: 'C',
            label: '家里搞',
        ...
        opts: [
          {
            ...
            effortKey: 'low',
            bodyHtml:
              '<p>浦东高桥。<b>近年上海公园里萤火虫最多的点</b>（人民网 / 东方网都报道过）。地铁 6 号线 + 公交 / 打车，晚上回家方便。</p>',
          },
          {
            letter: 'B',
            label: '上海植物园 / 辰山植物园',
            ...
            effortKey: 'med',
            bodyHtml:
              '<p>上海植物园（徐汇）观察记录有<b>黄脉翅萤、条背萤</b>等，夏至前后高峰；辰山植物园（松江）夜赏活动逐年办。<b>必须查公众号</b>当年是否开放夜场。</p>',
          },
          {
            letter: 'C',
            label: '青浦金泽 / 朱家角',
            ...
            effortKey: 'med',
            bodyHtml:
              '<p>近郊水网地带，光污染低。自驾约 1 小时。<b>密度大但要靠运气</b>，建议跟当地观萤微信群打听当年点位。</p>',
          },
        ],
      },
    ],
